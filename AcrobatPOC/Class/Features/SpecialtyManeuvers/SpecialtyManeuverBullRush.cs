    ...
    public class SpecialtyManeuverBullRush
    {
        ...
        public static void Configure() 
        {
            FeatureConfigurator.New(FeatureName, FeatureGuid)
                ...
                .AddCMBBonusForManeuver(maneuvers: [CombatManeuver.BullRush, CombatManeuver.AwesomeBlow, CombatManeuver.Overrun], value: ContextValues.Rank(), descriptor: Kingmaker.Enums.ModifierDescriptor.UntypedStackable)
                .SetRanks(1)
                .Configure();
        }
    }
